...
def megabeast_wrapper(megabeast_input_file, run_megabeast=False, diagnostic_plots=False, verbose=True):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--run_megabeast",
                            help="Run the MegaBEAST",
                            action="store_true")
    parser.add_argument("-p", "--diagnostic_plots",
    ...
    parser.add_argument("megabeast_input_file",
                        help="path+filename for the MegaBEAST input file")

    args = parser.parse_args()


    megabeast_wrapper(args.megabeast_input_file,
